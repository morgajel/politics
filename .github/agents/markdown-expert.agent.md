...
handoffs:
  - label: Design Documentation Architecture
    agent: Software Architect
    prompt: "Review how this documentation should be structured and delivered within the TypeScript web application or GitHub Pages site"
    send: false
  - label: View Report
    agent: agent
